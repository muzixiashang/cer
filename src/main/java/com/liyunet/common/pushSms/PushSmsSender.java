...
import com.liyunet.common.sms.SmsSingleSender;
import com.liyunet.common.sms.SmsSingleSenderResult;
...
//	private static final int TEMP_ID = 11548;
	...
	public static void send(String phoneNum) throws Exception{
		String sb= PushChangTianYouSmsUtil.sendSmsCode(phoneNum);
    	logger.error(sb.toString());
	}
	public static void send(String phoneNum,String code) throws Exception{
		String sb= PushChangTianYouSmsUtil.sendSmsCode(phoneNum,code);
		logger.error(sb.toString());
	}
